...
import { LocalStorageTokenData } from "./local-storage.helper";
...
fdescribe("AuthenticationHelper", () => {
  ...
  describe("signOut", () => {
    it("makes expected calls", () => {
      const localStorageHelperStub: LocalStorageHelper = TestBed.inject(LocalStorageHelper);
  ...
  describe("getUserId", () => {
    ...
    it("should be null", () => {
      const invalidModel = { ...localStorageModel, accessToken: INVALID_ACCESS_TOKEN };
